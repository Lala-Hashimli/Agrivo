...
const statusCards = [
  { label: "Pickup scheduled", tone: "bg-white text-[#14532D]", delay: 0.2 },
  { label: "In transit", tone: "bg-[#14532D] text-white", delay: 0.35, active: true },
  { label: "Delivered", tone: "bg-[#ecfdf5] text-[#166534]", delay: 0.5 },
];
    ...
    <div className="agrivo-logistics-hero-visual relative mx-auto w-full max-w-lg lg:max-w-none">
      ...
      >
        <div className="mb-4 flex items-center justify-between gap-3">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#15803d]">Live route</p>
            <p className="mt-1 text-sm font-semibold text-[#102018]">Lankaran Farm → Baku Market</p>
          </div>
            ...
            <div className="mt-6 flex items-end justify-center gap-3">
              {[1, 2, 3].map((crate) => (
                ...
                >
                  ...
                  <span className="mt-1 text-[9px] font-semibold text-[#166534]">Fresh</span>
                </div>
              ))}
            </div>
          </div>
