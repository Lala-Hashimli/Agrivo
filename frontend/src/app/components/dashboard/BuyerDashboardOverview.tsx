...
export function BuyerDashboardOverview() {
  ...
  return (
    <div className="agrivo-buyer-overview space-y-6">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm leading-6 text-[#5F6F64] sm:text-base">
              Manage your orders, saved products, cart, and marketplace activity.
            </p>
          </div>
      ...
      <section className="agrivo-buyer-split">
        <div className="agrivo-dashboard-panel agrivo-buyer-tracking">
          <div className="mb-4 flex items-start justify-between gap-3">
            <div>
              ...
              <h3 className="agrivo-heading mt-1 text-xl font-bold text-[#102018]">
                {buyerCurrentDelivery.product} · {buyerCurrentDelivery.quantity}
              </h3>
            </div>
          ...
          <div className="space-y-2 text-sm">
            <p className="text-[#5F6F64]">
              <span className="font-medium text-[#102018]">Farmer:</span> {buyerCurrentDelivery.farmer}
            </p>
            <p className="text-[#5F6F64]">
              <span className="font-medium text-[#102018]">Route:</span> {buyerCurrentDelivery.route}
            </p>
            <p className="text-[#5F6F64]">
              <span className="font-medium text-[#102018]">Estimated delivery:</span>{" "}
              {buyerCurrentDelivery.estimatedDelivery}
            </p>
          </div>
        ...
        <div className="agrivo-dashboard-panel">
          <div className="mb-4 flex items-center justify-between gap-3">
            <h3 className="agrivo-heading text-lg font-bold text-[#102018]">Recent Orders</h3>
            <button
              type="button"
      ...
      <section className="agrivo-dashboard-panel">
        <div className="mb-5 flex items-center justify-between gap-3">
          <div>
            ...
            <h3 className="agrivo-heading mt-1 text-lg font-bold text-[#102018]">Recommended Products</h3>
          </div>
          <button
            type="button"
            className="text-xs font-semibold text-[#14532D] hover:text-[#1D6A3B]"
          ...
          {buyerRecommendedProducts.map((product) => (
            <div key={product.id} className="agrivo-buyer-product-card agrivo-card">
              ...
              <div className="p-4">
                ...
                <h4 className="mt-1 font-semibold text-[#102018]">{product.name}</h4>
                <p className="mt-0.5 text-xs text-[#5F6F64]">{product.farmer}</p>
                <p className="mt-2 text-sm font-bold text-[#14532D]">{product.price}</p>
      ...
      <section className="agrivo-dashboard-panel">
        <div className="mb-4 flex items-center justify-between gap-3">
          <h3 className="agrivo-heading text-lg font-bold text-[#102018]">Saved Products</h3>
          <button
            type="button"
            className="text-xs font-semibold text-[#14532D] hover:text-[#1D6A3B]"
