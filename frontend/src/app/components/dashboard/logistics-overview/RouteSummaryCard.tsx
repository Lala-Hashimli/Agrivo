  ...
  return (
    <section className="agrivo-logistics-route-summary agrivo-dashboard-panel">
      <div className="agrivo-logistics-route-summary__header">
        ...
        <span className="agrivo-logistics-route-summary__eta">ETA {route.eta}</span>
      </div>
      ...
      <div className="agrivo-logistics-route-summary__meta">
        <div>
          <p className="text-xs font-medium uppercase tracking-wide text-[#6b7a70]">Stops</p>
          <p className="mt-0.5 text-sm font-semibold text-[#102018]">{route.stops}</p>
        </div>
        <div>
          <p className="text-xs font-medium uppercase tracking-wide text-[#6b7a70]">Distance</p>
          <p className="mt-0.5 text-sm font-semibold text-[#102018]">{route.distanceKm} km</p>
        </div>
        <div>
          <p className="text-xs font-medium uppercase tracking-wide text-[#6b7a70]">Driver</p>
          <p className="mt-0.5 text-sm font-semibold text-[#102018]">{route.driverName}</p>
        </div>
        <div>
          <p className="text-xs font-medium uppercase tracking-wide text-[#6b7a70]">Vehicle</p>
      ...
      <div className="agrivo-logistics-route-summary__progress">
        <div className="flex items-center justify-between gap-2">
          <p className="text-xs font-semibold text-[#5F6F64]">Route completion</p>
