...
export const agrivoNavigationItems = [
  { label: "Home", kind: "home" as const, target: "top" },
  { label: "Marketplace", kind: "page" as const, target: "products" },
  { label: "Farmers", kind: "page" as const, target: "farmers" },
  { label: "Farm Jobs", kind: "page" as const, target: "jobs" },
  { label: "Logistics", kind: "page" as const, target: "logistics" },
  { label: "Login", kind: "page" as const, target: "login" },
];
